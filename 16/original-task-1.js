// if I'm not mistaken, it's possible that another while loop/recursive function is needed to calculate all possible routes
// my heuristic will always take you down the best option from where you are, but perhaps there needs to be an overarching strategy
// just because going to JJ on the first loop is the best option at that point, it doesn't pay off in the long term
//
//
//
//
...
//
//
// make reference table showing the distances between all valves with flow > 0. this will save on computing power
// then brute force...
//
//
//
